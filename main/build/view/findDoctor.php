    ...
    <main class="flex flex-col items-center min-h-screen text-center ">
        ...
        <?php
            if (isset($_POST['specialization']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $doctors = Doctor::getDoctorBasedSpecialisation($specialization);

                if ($doctors) {
                    foreach ($doctors as $doctor) {
                        $schedule = new Schedule();
                        $schedule = $schedule->getDoctorSchedule($doctor["id"]);
                        ...
                        echo '<br><div class="p-8 rounded-xl border-2 border-black shadow-xl bg-gradient-to-r from-green-50 to-green-100">
                                ...
                                <div class="details hidden">
                                    ...
                                    <p class="mt-2 text-gray-500">starting_weekday: ' . $schedule["startDay"] . '</p>
                                    <p class="mt-2 text-gray-500">ending_weekday: ' . $schedule["endDay"] . '</p>
                                    <p class="mt-2 text-gray-500">start_hour: ' . $schedule["start_time"] . '</p>
                                    <p class="mt-2 text-gray-500">end_hour: ' . $schedule["end_time"] . '</p>
                                </div>
                    ...
                    echo '<p class="text-red-500 mt-10 mb-10">No doctors found for the selected specialty.</p>';
                }
            }
